...
: ${AMENT_CURRENT_PREFIX:="/root/workspace/install/mio_robot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mio_robot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mio_robot_moveit_config/environment/path.sh"
